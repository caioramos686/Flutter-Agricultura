class ConsultaCertificadoPromotorEventosConcentracaoAnimalModel {
  ConsultaCertificadoPromotorEventosConcentracaoAnimalModel({
  ...
  ConsultaCertificadoPromotorEventosConcentracaoAnimalModel.fromJson(Map<String, dynamic> json) {
