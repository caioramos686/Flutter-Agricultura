class ConsultaCertificadoComercioProdutosInsumosVetModel {
  ConsultaCertificadoComercioProdutosInsumosVetModel({
  ...
  ConsultaCertificadoComercioProdutosInsumosVetModel.fromJson(Map<String, dynamic> json) {
